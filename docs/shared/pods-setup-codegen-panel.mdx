...
The Codegen CLI uses a JSON file to configure the code generation engine. Initializing the Codegen CLI creates this file with the default values. From the directory of your `Podfile`, run:
...
This will create an `apollo-codegen-config.json` file with the default options.
