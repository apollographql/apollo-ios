...
import SetupCodegenPanel from "../shared/setup-codegen-panel.mdx"
...
<SetupCodegenPanel cliPath="./apollo-ios-cli" installComponent={<SPMInstallCLI />} />
...
<SetupCodegenPanel cliPath="./apollo-ios-cli" installComponent={<SPMXcodeInstallCLI />} />
...
<SetupCodegenPanel cliPath="./Pods/Apollo/apollo-ios-cli" installComponent={<PodsInstallCLI />} />
