...
The resulting operation manifest json would like this: 
...
> **Note:** This example is using the `persistedQueries` version of the operation manifest, the `legacyAPQs` version will look slightly different.
