...
GraphQL errors are returned as type-safe [`GraphQLError`](https://www.apollographql.com/docs/ios/docc/documentation/apollo/graphqlerror) values. These values are parsed from the response as described in the section on [response format errors in the GraphQL specification](https://graphql.github.io/graphql-spec/June2018/#sec-Errors).
