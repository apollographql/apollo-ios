...
Both named and inline fragments can be used as [type conditions](./type-conditions), which enables you to access fields of [polymorphic types](https://www.apollographql.com/docs/apollo-server/schema/unions-interfaces/). Read the [guide on type conditions](./type-conditions) to learn more.
