...
In this section, you'll add the ability to log in to your server and obtain a token that your client can use to make identified requests.
...
A **mutation** is an operation that changes state on your server. In this case, the mutation changes back-end state by creating a login session for your client.
...
Next, add basic email validation to help ensure that the String you'll be passing through to the server is an email address:
