...
![constraints builder with those constraints](../images/login_stackview_constraints.png)

In the right sidebar, update the settings of the Stack View in the Attributes Inspector to these:

![vertical axis fill alignment fill distribution spacing 8 uncheck baseline relative](../images/login_stackview_details.png)
...
![text "Log In" font Large Title](../images/login_title_label_details.png)

Add a `UITextField` to the stack view. Select it, go to the Attributes Inspector panel, and update the placeholder text:

![placeholder "email address"](../images/login_textfield_details.png)
...
![text "Errors" color System Red font Body lines 0](../images/login_error_label_details.png)
...
![title text "Submit"](../images/login_button_details.png)
...
![the output of the search](../images/interface_builder_bar_button_item.png)
...
![system item Cancel](../images/login_cancel_button_details.png)
