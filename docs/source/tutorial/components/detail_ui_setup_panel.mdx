...
<<<<<<< HEAD
>**Note**: You may still see some sizing errors at this point, but those will go away in the next step.

=======
>>>>>>> add UI setup panel and start adding other stuff around fleshing out the detail
