...
import SPMInstallationPanel from "./spm-installation-panel.mdx"
import PodsInstallationPanel from "./pods-installaion-panel.mdx"
...
You can install `Apollo.framework` into your project using Swift Package Manager, CocoaPods, Carthage, or by [manually integrating it with Xcode](#manual-integration).
