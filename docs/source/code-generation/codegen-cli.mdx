...
You can run the CLI from there, move it to another location, or add it to your shell's `$PATH`.
...
> For more information on configuring code generation, see [Code generation configuration](./codegen-configuration).
