...
| Property Name | Description |
| ----- | ----------- |
| `path` | Local path where the generated operation manifest file should be written. Paths beginning with `./` are relative to your projects root directory, all other paths are absolute file paths on your system. |
