...
A schema is provided by every GraphQL server. Tou can generally get your schema from your server via an introspection query or from [Apollo Studio](https://www.apollographql.com/docs/studio/).
