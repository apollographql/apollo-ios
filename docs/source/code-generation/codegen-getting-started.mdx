...
Browse to the list of [Apollo iOS releases](https://github.com/apollographql/apollo-ios/releases) in GitHub and find the latest release. In the Assets list for each release will be a pre-built CLI binary.

Download or move the already downloaded CLI binary file into the directory you created in [Step 1](#step-1-setup).
