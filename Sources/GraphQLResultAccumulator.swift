public protocol GraphQLResultAccumulator: class {
  ...
  func accept(fieldEntries: [FieldEntry], info: GraphQLResolveInfo) throws -> PartialResult
  
  func finish(rootValue: PartialResult, info: GraphQLResolveInfo) throws -> FinalResult
}
...
public final class Zip2Accumulator<Accumulator1: GraphQLResultAccumulator, Accumulator2: GraphQLResultAccumulator>: GraphQLResultAccumulator {
  ...
  public func accept(fieldEntries: [FieldEntry], info: GraphQLResolveInfo) throws -> PartialResult {
  ...
  public func finish(rootValue: PartialResult, info: GraphQLResolveInfo) throws -> FinalResult {
