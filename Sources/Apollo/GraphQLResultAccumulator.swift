...
final class Zip4Accumulator<Accumulator1: GraphQLResultAccumulator, Accumulator2: GraphQLResultAccumulator, Accumulator3: GraphQLResultAccumulator, Accumulator4: GraphQLResultAccumulator>: GraphQLResultAccumulator {
  ...
  func accept(list: [PartialResult], info: GraphQLResolveInfo) throws -> PartialResult {
    ...
    return (try accumulator1.accept(list: list1, info: info), try accumulator2.accept(list: list2, info: info), try accumulator3.accept(list: list3, info: info), try accumulator4.accept(list: list4, info: info))
  }

  func accept(fieldEntry: PartialResult, info: GraphQLResolveInfo) throws -> FieldEntry {
    return (try accumulator1.accept(fieldEntry: fieldEntry.0, info: info), try accumulator2.accept(fieldEntry: fieldEntry.1, info: info), try accumulator3.accept(fieldEntry: fieldEntry.2, info: info), try accumulator4.accept(fieldEntry: fieldEntry.3, info: info))
  }

  func accept(fieldEntries: [FieldEntry], info: GraphQLResolveInfo) throws -> ObjectResult {
    let (fieldEntries1, fieldEntries2, fieldEntries3, fieldEntries4) = unzip(fieldEntries)
    return (try accumulator1.accept(fieldEntries: fieldEntries1, info: info), try accumulator2.accept(fieldEntries: fieldEntries2, info: info), try accumulator3.accept(fieldEntries: fieldEntries3, info: info), try accumulator4.accept(fieldEntries: fieldEntries4, info: info))
  }

  func finish(rootValue: ObjectResult, info: GraphQLResolveInfo) throws -> FinalResult {
    return (try accumulator1.finish(rootValue: rootValue.0, info: info), try accumulator2.finish(rootValue: rootValue.1, info: info), try accumulator3.finish(rootValue: rootValue.2, info: info), try accumulator4.finish(rootValue: rootValue.3, info: info))
  }
}
