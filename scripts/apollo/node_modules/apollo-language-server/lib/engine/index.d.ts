...
import { ListServicesVariables, CheckSchemaVariables, UploadSchemaVariables, UploadAndComposePartialSchemaVariables, RegisterOperationsVariables, ValidateOperationsVariables, CheckPartialSchemaVariables, RemoveServiceAndComposeVariables } from "../graphqlTypes";
...
export declare class ApolloEngineClient extends GraphQLDataSource {
    ...
    checkPartialSchema(variables: CheckPartialSchemaVariables): Promise<import("../graphqlTypes").CheckPartialSchema_service_validatePartialSchemaOfImplementingServiceAgainstGraph>;
