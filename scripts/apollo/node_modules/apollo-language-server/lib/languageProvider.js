    ...
    async provideCompletionItems(uri, position, _token) {
        ...
        if (state.kind === "Directive") {
            return suggestions.map(suggest => {
                ...
                return Object.assign({}, suggest, { documentation: doc, insertText: snippet, insertTextFormat: vscode_languageserver_1.InsertTextFormat.Snippet });
            });
        }
        return suggestions;
    }
            ...
            switch (node.kind) {
                ...
                case graphql_1.Kind.FIELD: {
                    ...
                    if (parentType && fieldDef) {
                        ...
                        const isResolvedLocally = source_1.isFieldResolvedLocally(node, document.ast);
                        const content = [
                            [
                                `\`\`\`graphql`,
