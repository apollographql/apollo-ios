import { Source, ASTNode, TypeInfo, GraphQLSchema, Visitor, ASTKindToNode, FieldNode } from "graphql";
...
export declare function isFieldResolvedLocally(fieldNode: FieldNode, root: ASTNode): boolean | null;
