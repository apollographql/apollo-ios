...
public class AllAnimalsIncludeSkipQuery: GraphQLQuery {
  ...
  public struct Data: MyCodegenTargetDestination.SelectionSet {
    ...
    ///
    /// Parent Type: `Animal`
    public struct AllAnimal: MyCodegenTargetDestination.SelectionSet {
      public let __data: DataDict
      public init(data: DataDict) { __data = data }
      ...
      ///
      /// Parent Type: `Animal`
      public struct Predator: MyCodegenTargetDestination.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
        ...
        public struct AsWarmBlooded: MyCodegenTargetDestination.InlineFragment {
          public let __data: DataDict
          public init(data: DataDict) { __data = data }
      ...
      public struct AsWarmBlooded: MyCodegenTargetDestination.InlineFragment {
        ...
        ///
        /// Parent Type: `WarmBlooded`
        public struct IfGetWarmBlooded: MyCodegenTargetDestination.InlineFragment {
          public let __data: DataDict
          public init(data: DataDict) { __data = data }
      ...
      ///
      /// Parent Type: `Pet`
      public struct AsPet: MyCodegenTargetDestination.InlineFragment {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
      ...
      ///
      /// Parent Type: `Cat`
      public struct AsCat: MyCodegenTargetDestination.InlineFragment {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
      ...
      public struct AsClassroomPet: MyCodegenTargetDestination.InlineFragment {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
        ...
        ///
        /// Parent Type: `Bird`
        public struct AsBird: MyCodegenTargetDestination.InlineFragment {
          public let __data: DataDict
          public init(data: DataDict) { __data = data }
      ...
      ///
      /// Parent Type: `Animal`
      public struct IfNotSkipHeightInMeters: MyCodegenTargetDestination.InlineFragment {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
