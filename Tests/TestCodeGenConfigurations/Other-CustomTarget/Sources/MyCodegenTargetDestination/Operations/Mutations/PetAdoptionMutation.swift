...
public class PetAdoptionMutation: GraphQLMutation {
  ...
  public struct Data: MyCodegenTargetDestination.SelectionSet {
    ...
    public static var __parentType: ParentType { .Object(MyCodegenTargetDestination.Mutation.self) }
    ...
    ///
    /// Parent Type: `Pet`
    public struct AdoptPet: MyCodegenTargetDestination.SelectionSet {
      public let __data: DataDict
      public init(data: DataDict) { __data = data }
