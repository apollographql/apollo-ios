...
public struct ClassroomPetDetails: GraphQLSchemaName.SelectionSet, Fragment {
  ...
  public struct AsPetRock: GraphQLSchemaName.InlineFragment {
    ...
    public static var __parentType: ParentType { .Object(GraphQLSchemaName.PetRock.self) }
    public static var selections: [Selection] { [
