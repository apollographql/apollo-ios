...
public class Dog: MockObject {
  public static let objectType: Object = GraphQLSchemaName.Objects.Dog
  public static let _mockFields = MockFields()
  public typealias MockValueCollectionType = Array<Mock<Dog>>

  public struct MockFields {
    @Field<GraphQLSchemaName.CustomDate>("birthdate") public var birthdate
...
public extension Mock where O == Dog {
  convenience init(
    birthdate: GraphQLSchemaName.CustomDate? = nil,
