...
public class Height: MockObject {
  public static let objectType: Object = MyCustomProject.Objects.Height
  ...
  public struct MockFields {
    ...
    @Field<GraphQLEnum<MyCustomProject.RelativeSize>>("relativeSize") public var relativeSize
  }
}
...
public extension Mock where O == Height {
  convenience init(
    ...
    inches: Int? = nil,
    meters: Int? = nil,
    relativeSize: GraphQLEnum<MyCustomProject.RelativeSize>? = nil
  ) {
    self.init()
