...
public class Dog: MockObject {
  public static let objectType: Object = MyCustomProject.Objects.Dog
  public static let _mockFields = MockFields()
  public typealias MockValueCollectionType = Array<Mock<Dog>>

  public struct MockFields {
    @Field<MyCustomProject.CustomDate>("birthdate") public var birthdate
...
public extension Mock where O == Dog {
  convenience init(
    birthdate: MyCustomProject.CustomDate? = nil,
