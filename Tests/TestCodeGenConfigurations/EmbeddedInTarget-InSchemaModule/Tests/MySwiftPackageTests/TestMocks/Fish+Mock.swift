...
extension MyGraphQLSchema.Fish: Mockable {
  public static let __mockFields = MockFields()

  public typealias MockValueCollectionType = Array<Mock<MyGraphQLSchema.Fish>>
...
public extension Mock where O == MyGraphQLSchema.Fish {
  convenience init(
