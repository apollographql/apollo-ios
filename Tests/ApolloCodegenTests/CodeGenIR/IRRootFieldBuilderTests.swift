...
class IRRootFieldBuilderTests: XCTestCase {
  ...
  func test__crash__givenUsesFragmentsReferencingOtherFragment_includesBothFragments() throws {
    // given
    schemaSDL = """
    type Query {
      books: [Book!]!
    ...
    let expected: OrderedSet = [
      try ir.builtFragments["BookPriceFragment"].xctUnwrapped(),
      try ir.builtFragments["MoneyFragment"].xctUnwrapped(),
    ]
